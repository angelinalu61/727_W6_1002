...
ggplot(top_25_words, aes(x = reorder(word, total_n), y = total_n, fill = total_n)) +
  geom_col(show.legend = FALSE) +
  labs(x = NULL, y = "Frequency", title = "Top 25 Most Common Words Across All Commmunity Areas") +
  coord_flip() +
  theme_minimal() +
  theme(
